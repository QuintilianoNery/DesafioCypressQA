...
- OBS: Como informado na documentação do cypress, o comando [cy.writeFile](https://docs.cypress.io/api/commands/writefile#Examples) para salvar as informações em um arquivo, só podem ser em dois formatos, txt e JSON, por este motivo a planilha ficou nesse formato exibido no link Resultados.csv
